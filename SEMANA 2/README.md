...
* Subtítulo: Sistema para la gestión y venta de celulares tecnologicos.
* Nombre del estudiante: Nixon Dario.
...
Aplicar los conocimientos básicos de instalación, configuración y uso de Visual Studio Code, creación de páginas web con HTML y publicación de proyectos en GitHub.
